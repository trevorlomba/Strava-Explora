import jinja2
import os
from strava_exploration1 import next_week_goal, week_prog, miles_left, days_zero_last_14, days_zero_last_3, days_zero_last_7, last_run_average_cadence, pace_vs_cadence_r2, heartrate_vs_cadence_r2
...
html_output = template.render(next_week_goal=next_week_goal.round(1), week_prog=week_prog.round(1), miles_left=miles_left.round(1),  total_distance_by_week='visualizations/Total Distance by Week.png',
                              ...
                              average_cadence = last_run_average_cadence,
